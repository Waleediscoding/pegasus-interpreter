...
class CommaExpr : public Expr
{
  public:
    ...
    CommaExpr(ExprPtrs exprPtrs, int lineNum) : m_exprPtrs{std::move(exprPtrs)}, m_lineNum{lineNum}
    {
    }

    void accept(Visitor& visitor) override { visitor.visitCommaExpr(*this); }
};
...
class Unary : public Expr
{
  public:
    ...
    Unary(Token op, ExprPtr right) : m_op{op}, m_right{std::move(right)} {}
...
class Literal : public Expr
{
  public:
    ...
    Literal(LitVal value) : m_value{value} {}
...
class Variable : public Expr
{
  public:
    ...
    void accept(Visitor& visitor) override { visitor.visitVarExpr(*this); }
};
...
class Keyword : public Expr
{
  public:
    ...
    Keyword(Token name) : m_name{name} {}

    void accept(Visitor& visitor) override { visitor.visitKeywordExpr(*this); }
};
