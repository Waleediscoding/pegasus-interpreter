...
struct ReturnSignal {
    ...
    ReturnSignal(LitVal value) : m_value{value} {}
};
...
class InterpreterException : public std::exception
{
  ...
  public:
    ...
    EXIT_CODE exitCode() const noexcept { return m_code; }

    int exitCodeInt() const noexcept { return static_cast<int>(m_code); }

    int lineNum() const noexcept { return m_lineNum; }

    bool shouldTerminate() const noexcept { return m_terminate; }
};
...
class RuntimeException : public std::exception
{
  ...
  public:
    ...
    int exitCodeInt() const noexcept { return static_cast<int>(m_exitCode); }
};