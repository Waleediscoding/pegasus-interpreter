...
class PrintStmt : public Stmt
{
  public:
    ...
    PrintStmt(ExprPtr expression) : m_expression{std::move(expression)} {}
...
class InputStmt : public Stmt
{
  public:
    ...
    InputStmt(ExprPtr expression) : m_expression{std::move(expression)} {}
...
class ExprStmt : public Stmt
{
  public:
    ...
    ExprStmt(ExprPtr expression) : m_expression{std::move(expression)} {}
...
class VarStmt : public Stmt
{
  public:
    ...
    VarStmt(Token name, ExprPtr initialiser) : m_name{name}, m_initialiser{std::move(initialiser)}
    {
    }
...
class IfStmt : public Stmt
{
  public:
    ...
    IfStmt(ExprPtr condition, StmtPtr body, StmtPtr next, int lineNum)
        : m_condition{std::move(condition)}, m_body{std::move(body)}, m_next{std::move(next)},
          m_lineNum{lineNum}
    {
    }
...
class BlockStmt : public Stmt
{
  public:
    ...
    BlockStmt(StmtPtrs stmts) : m_stmts{std::move(stmts)} {}
...
class KeywordStmt : public Stmt
{
  public:
    ...
    KeywordStmt(ExprPtr keyword) : m_keyword{std::move(keyword)} {}

    void accept(StmtVisitor& visitor) override { visitor.visitKeywordStmt(*this); }
};
